...
class View {
    ...
    static default_scaling() {
        var param = {
            scale: GraphUtils.get_css_number('--svg-scale'),
            scale_min: GraphUtils.get_css_number('--svg-scale-min'),
            scale_max: GraphUtils.get_css_number('--svg-scale-max')
        };
    ...
    static set_svgscale(svgobj) {
        ...
        d.scale = GraphUtils.parse_number( d3.select("#svgscale").property("value") );
        d.scale_min = GraphUtils.parse_number( d3.select("#svgscale").property("min") );
        d.scale_max = GraphUtils.parse_number( d3.select("#svgscale").property("max") );
