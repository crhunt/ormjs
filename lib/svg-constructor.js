...
class ORMSvg {
    ...
    static generateID() {
        ...
        var svgID = "canvas-svg-" + orm.highestSvgID.toString();
        orm.highestSvgID += 1;
        return svgID
    }
    ...
    create_d3object(data) {
        ...
        var newsvg = d3.select("#canvas")
            ...
            .attr("viewBox", () => ORMSvg.set_viewbox(this.param.svgscale))
    ...
    static set_svgscale(svgobj) {
        ...
        // Set viewBox
        svgobj.d3object
            .attr("viewBox", () => ORMSvg.set_viewbox(svgobj.param.inv_scale))
    ...
    link_svgscale() {
        ...
        d3.select("#svgscale")
            ...
            .on("change", () => { ORMSvg.set_svgscale(this) });
    }
