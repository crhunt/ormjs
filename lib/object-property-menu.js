...
function rotate_uconstraint(event,d) {
    ...
    /* Select the next uniqueness constraint to display above the rolebox.
       ...
       Set by available_uconstraints. This function selects the next in the list
       and displays it above the rolebox in the property menu when the rolebox 
       is clicked. */
