...
function rotate_rolebox_group(rbgroup) {
    ...
    // Check flip condition and redraw connected relationships
    check_flip_and_relationships(rbgroup);
}

function check_flip_and_relationships(rbgroup) {
    // Check flip condition and redraw connected relationships
    ...
    // Redraw all connected relations
    redraw_relationships(d.relationships);
