...
function get_rbgroupID(anyID) {
    // From any sub-component of the rolebox group, get the group ID
...
function draw_rolebox(x,y) {
    ...
    // Draw a new instance of a rolebox group
...
function set_rb_uniqueness_constraint(rbox) {
    ...
    // Change the rolebox uniqueness constraint based on datum.
...
/*  Flipping
    ...
    This usually happens when display99999999999999ed on the right side of the first entity
    linked to the group.
 */
