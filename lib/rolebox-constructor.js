...
function rolebox_number(rbID) {
    // rbID is a rolebox group ID generated by generate_roleboxID
    return rbID.split("-")[2]
}

function set_highest_rolebox_ID() {
    // Count rolebox groups when you load a diagram from a file
...
function flip_mandatory_role(rbox) {
    ...
    // Redraw all connected connectors
    //set_eligible_overlays(conn);
    console.log(conn.attr("id"),conn.datum())
...
function delete_rolebox(rbox) {
    ...
    for ( n in conns ) {
        console.log("deleting connector", conns[n]);
