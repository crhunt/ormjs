...
class Predicate {
    ...
    duplicate() {
        ...
        var rng = range(boxes.length-1,1);
        for ( var n in rng ) {
        ...
        //set_rolebox_display_name(predcopy);
    ...
    actions() {
        ...
        d3.select("#"+`add-${this.id}`)
            ...
            .on("click", function(event) {
                var predID = get_parentID( event.target.id.toString() );
    ...
    delete() {
        ...
        var x = this.d3object.datum().xc; 
        var y = this.d3object.datum().yc; 
        this.d3object
            .transition()
            .duration(500)
...
class Rolebox {
    ...
    set_internal_uc() {
        ...
        var gd = d3.select(`#${this.parent}`).datum();
        var d = this.d3object.datum();
    ...
    remove(event,d) {
        ...
        var rboxID = get_parentID( event.target.id.toString() );
    ...
    delete() {
        ...
        gd.boxes = remove_from_array( gd.boxes, this.id );
