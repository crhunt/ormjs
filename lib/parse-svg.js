...
function populate_state() {
    ...
    orm.highestEntityID = set_highest_ID(orm.entities, orm.highestEntityID);
    ...
    orm.highestConnID = set_highest_ID(orm.connectors, orm.highestConnID);
    ...
    orm.highestRBID = set_highest_ID(orm.rbgroups, orm.highestRBID);
}

function set_highest_ID(objlist, highest) {
    // Count entities when you load a diagram from a file
...
function object_number(anyID) {
    // entityID is for the entire entity group, generated by generate_entityID
