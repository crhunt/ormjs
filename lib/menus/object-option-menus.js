    ...
    [
        ...
        },
        {
            ...
            action: function(d, event) { 
                ...
                object.d3object.classed("selected") ? unclass_as(object.attr("id"),"selected")
                                                    : class_as(object.attr("id"),"selected");
            }
        },
        {
            title: 'Properties',
    ...
    [
        ...
        },
        {
            ...
            action: function(d, event) { 
                ...
                var object = orm.values[ get_parentID(targetID) ];
                if (object == null) { return }
                object.classed("selected") ? unclass_as(object.attr("id"),"selected")
                                           : class_as(object.attr("id"),"selected");
            }
        },
        {
