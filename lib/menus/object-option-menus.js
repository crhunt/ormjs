        ...
        return [
            {
                ...
                action: function(d, event) { 
                    ...
                    new ormjs.Entity( {x:mouse[0], y:mouse[1], model:modelID} );
                }
            },
            {
                title: 'Fact',
                action: function(d, event) { 
                    ...
                    new ormjs.Predicate( {x:mouse[0], y:mouse[1], model:modelID} );
                }
            },
            {
                title: 'Value',
                action: function(d, event) { 
                    ...
                    new ormjs.Value( {x:mouse[0], y:mouse[1], model:modelID} );
                }
            },
            {
                title: 'Constraint',
                action: function(d, event) { 
                    ...
                    var mouse = d3.pointer(event,event.target);
                    new ormjs.Constraint( {x:mouse[0], y:mouse[1], model:modelID} );
                }
            },
            {
                divider: true
        ...
        return [
            {
                ...
                action: function(d, event) { 
                    ...
                    var entity = model.objects.entity[ ormjs.Graph.get_parentID(targetID) ];
            ...
            },
            {
                title: function(d, event) {
                    ...
                    // Get object
                    var targetID = event.target.id.toString();
                    var object = model.objects.entity[ ormjs.Graph.get_parentID(targetID) ];
            ...
            },
            {
                ...
                action: function(d, event) { 
                    // Delete entity
                    //remove_entity(event);
                    ormjs.Entity.remove(event,modelID);
                }
            }
        ];
    }
    ...
    [
        {
            ...
            action: function(d, event) { 
                // Duplicate value
                var targetID = event.target.id.toString();
                var value = orm.values[ ormjs.Graph.get_parentID(targetID) ];
        ...
        },
        {
            title: function(d, event) {
                ...
                // Get object
                var targetID = event.target.id.toString();
                var object = orm.values[ ormjs.Graph.get_parentID(targetID) ];
                // Not sure what we clicked on? (catch-all)
                if (object == null) { return "Select" }
                // Check slected condition
                if ( object.d3object.classed("selected") ) {
    ...
    [
        ...
        },
        {
            title: function(d, event) {
                ...
                // Get rolebox group
                var targetID = event.target.id.toString();
                var rbgroup = orm.rbgroups[ ormjs.Graph.get_parentID(targetID) ];
                // Not sure what we clicked on? (catch-all)
        ...
        },
        {
            title: function(d, event) {
                ...
                // Get object
                var targetID = event.target.id.toString();
                var object = orm.rbgroups[ ormjs.Graph.get_parentID(targetID) ];
                // Not sure what we clicked on? (catch-all)
                if (object == null) { return "Select" }
                // Check slected condition
                if ( object.d3object.classed("selected") ) {
    ...
    [
        {
            title: function(d, event) {
                ...
                // Get object
                var targetID = event.target.id.toString();
                var object = orm.connectors[ ormjs.Graph.get_parentID(targetID) ];
                // Not sure what we clicked on? (catch-all)
    ...
    [   
        {
            ...
            action: function(d, event) { 
                // Duplicate value
                var targetID = event.target.id.toString();
                var constraint = orm.constraints[ ormjs.Graph.get_parentID(targetID) ];
        ...
        },
        {
            title: function(d, event) {
                ...
                // Get object
                var targetID = event.target.id.toString();
                var object = orm.constraints[ ormjs.Graph.get_parentID(targetID) ];
                // Not sure what we clicked on? (catch-all)
                if (object == null) { return "Select" }
                // Check slected condition
                if ( object.d3object.classed("selected") ) {
