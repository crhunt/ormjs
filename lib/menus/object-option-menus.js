    ...
    static rolebox_menu(modelID) {
        ...
        return [
            ...
            },
            {
                title: function(d, event) {
                    /* Rotate */
                    return ormjs.OptionMenu.conditional_label(event,objects.predicate,"Rotate","rotated")
                },
                action: function(d, event) {
                    // Get rolebox group
                    var targetID = event.target.id.toString();
                    var rbgroup = objects.predicate[ ormjs.Graph.get_parentID(targetID) ];
            ...
            },
            {
                title: function(d, event) {
                    /* Flip */
                    return ormjs.OptionMenu.conditional_label(event,objects.predicate,"Flip","flipped")
                },
                action: function(d, event) {
                    // Get rolebox group
                    var targetID = event.target.id.toString();
            ...
            },
            {
                title: 'Duplicate',
                action: function(d, event) { 
                    ormjs.OptionMenu.duplicate_action(event,objects.predicate);
                }
            },
            {
                title: function(d, event) {
                    /* Select */
                    return ormjs.OptionMenu.select_label(event,objects.predicate)
                },
                action: function(d, event) { 
                    ormjs.OptionMenu.select_action(event,objects.predicate);
                }
            },
            {
                title: 'Properties',
