...
class Constraint {
    ...
    static draw_constraint(d3parent) {
        ...
        var radius = parse_number( get_css_variable('--constraint-radius') );
        var oradius = parse_number( get_css_variable('--constraint-oradius') );
    ...
    static constraint_path(d3object, r=-1) {
        ...
        if(r < 0) { r = parse_number( get_css_variable('--constraint-radius') ); }
        var paths = {
