...
function check_orm_logic(rel) {
    ...
    if ( d_to.kind == "entity" && d_from.kind == "entity") {
        ...
        if ( d_from.entity == null ) {
            ...
            // Check flip condition for rolebox group and redraw connected relationships
            check_flip_and_relationships( d3.select("#"+d_from.parent) );
        } else {
            rd.to = "";
            return
        }
        ...
        if ( d_to.entity == null ) {
            ...
            // Check flip condition for rolebox group and redraw connected relationships
            check_flip_and_relationships( d3.select("#"+d_to.parent) );
        } else {
            rd.to = "";
            return
        }
