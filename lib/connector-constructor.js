...
function draw_conn_line(x1, y1, x2, y2) {
    ...
    /*
       Define the connection generically, on a drag event from
       an object overlay. 
...
function connect_to_objects(conn) {
    ...
    /*
       Using the information in the conn's datum,
       determine what the conn is connected to and update
       the object(s) datum(s) to reflect the connection.
     */
...
function remove_from_objects(conn) {
    ...
    /*
       ...
       Using the information in the conn's datum,
       determine what the conn is connected to and update
       the object(s) datum(s) to remove the connection.
     */
