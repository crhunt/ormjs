        ...
        */
        ...
        if ( cd.conntype == conntypes.default ) {
            ...
            if ( draw_arrows.includes(type) && cd.directed ) {
                conn.attr("d", function() { return constraintArrowPath(lineparam.length) })
                    .attr("class",`connector ${connclass.CtoRB} connected arrow${np}`)
                    .attr("transform", lineparam.transform );
            } 
            else if ( cd.to == "" || cd.from == "" ) {
                conn.attr("d", function() { return linePath(lineparam.length) })
            ...
            cd.preferred ? conn.attr("d", function() { return subtypePath(lineparam.length) })
                               .attr("class",`connector ${connclass.subtype}${np}`)
                               .attr("transform", lineparam.transform )
                         : conn.attr("d", function() { return subtypePathDashed(lineparam.length) })
            ...
            conn.attr("d", function() { return linePath(lineparam.length) })
                ...
                .attr("transform", lineparam.transform );
                  ...
                  cd.mandatory == true) {
            conn
                .attr("d", function() { return mandatoryPath(lineparam.length) })
