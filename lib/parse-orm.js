...
function metamodel_match_fact(rbgroup) {
    ...
    /* The parameters that have to match depend on whether we are using shortFormat
       ...
       details are different. (Different IUCs, etc.) Unlike objects, "matching" facts
       are each added to the metamodel, and _Shadows reference other ormjs rolebox 
       groups with the same fact name. */
