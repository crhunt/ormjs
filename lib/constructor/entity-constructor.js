...
ormjs.Entity = class {
    ...
    create_d3object(data) {
        ...
        // Name
        var ename = "Entity "+ormjs.Graph.object_number(this.id);
    ...
    name(ename) {
        if(arguments.length > 0) { 
            this.d3object.datum().name = ename;
            this.update_display_name();
    ...
    reference_mode(mode,rtype="popular") {
        ...
        if(arguments.length > 0) { 
            ...
            return { mode: d.refmode, type: d.reftype }
        }
    }
    ...
    actions() {
        ...
        this.d3object
            ...
            .on("click", ormjs.Graph.remove) // Ctrl+click --> remove entity
            .call(drag_entity);
    ...
    dragended(event,d) {
        ...
        rbgroups.map( (rbgroupID) => {
            objects["predicate"][rbgroupID].update_flip();
        });
    }
