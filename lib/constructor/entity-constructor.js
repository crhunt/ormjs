...
ormjs.Entity = class {
    ...
    constructor(data) {
        ...
        if(!data.d3object) {
            ...
            this.view = data.view.id;
            this.model = data.model ? data.model
                                    : ormjs.models[data.view.model].id;
    ...
    duplicate() {
        ...
        // Set datum
        var view = ormjs.models[this.model].objects.views[this.view];
        var dc = {x: x, y:y, model: this.model, view: view};
