...
ormjs.Predicate = class {
    ...
    static generateID(modelID) {
        ...
        orm.highestRBID += 1;
        return rbID*/
        return ormjs.Model.generateID(modelID,"rolebox_group")
    }
    ...
    create_d3object(data) {
        ...
        var rbgroup = svg.append("g")
            .datum( d )
            .attr("id", this.id)
            .attr("class", "ormjs-rolebox_group")
...
ormjs.Rolebox = class {
    ...
    delete() {
        ...
        var objects = ormjs.models[this.model].objects;
        var rbgroup = objects["rolebox_group"][ this.parent ];
    ...
    bubble_connectors() {
        ...
        var predicates = ormjs.models[this.model].objects["rolebox_group"];
