...
ormjs.Model = class {
    ...
    populate_metamodel() {
        ...
        var metamodel = new ormjs.Metamodel(this.id);

        // Add all objects
        var objects = ormjs.models[this.id].objects;
        // Add entities
        metamodel.add_objects(objects.entity,"EntityType");
        // Add values
        metamodel.add_objects(objects.value,"ValueType");
