...
ormjs.Model = class {
    ...
    populate_metamodel() {
        ...
        this.initialize_metamodel();
        // Add all objects
        var objects = ormjs.models[this.id].objects;
        // Add entities
        this.metamodel.add_objects(objects.entity,"EntityType");
        // Add values
        this.metamodel.add_objects(objects.value,"ValueType");

        // Add all facts
        this.metamodel.add_facts(objects.rolebox_group);

        // Add all constraints
        // TO DO

        // Generate XML
        this.metamodel.toXML();
