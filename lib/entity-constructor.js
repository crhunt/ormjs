...
class Entity {
    ...
    closest_overlay(pos) {
        ...
        /* Get position of closest overlay to position */
    ...
    overlay_positions() {
        ...
        // Entity position
        var x = this.d3object.datum().x;
        var y = this.d3object.datum().y;
        var width = parseInt( this.d3object.attr("width") );
        var height = parseInt( this.d3object.attr("height") );
        var xyoverlay = {
            "bottom" : { x: x,
                      y : y + height/2, 
                      location : "bottom" },
