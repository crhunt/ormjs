...
var entity_param = {
    height : GraphUtils.get_css_number('--entity-height'),
    snapTolerance : GraphUtils.get_css_number('--entity-height')/10
};
...
class Entity {
    ...
    create_d3object(data) {
        ...
        Graph.draw_overlay(entity,"eoverlay");
    ...
    closest_overlay(pos) {
        ...
        return Graph.closest_location(pos,xyo);
    }
